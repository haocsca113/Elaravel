            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ URL::to('/delete-brand-product/'.$brand_pro->brand_id) }}" class="active styling-edit" ui-toggle-class="" onclick="return confirm('Bạn có chắc chắn muốn xóa thương hiệu sản phẩm này không?')">
