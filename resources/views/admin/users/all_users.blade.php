                        ...
                        <form action="{{ url('/assign-roles') }}" method="POST">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-danger" href="{{ url('/delete-user-roles/'.$user->admin_id) }}" style="margin: 5px 0;" onclick="return confirm('Bạn có chắc chắn muốn xóa user này không?')">Xóa user</a>
                                    <a class="btn btn-sm btn-success" href="{{ url('/impersonate/'.$user->admin_id) }}" style="margin: 5px 0;">Chuyển quyền</a>
                                </td>
                            </tr>
                        </form>
                    @endforeach
