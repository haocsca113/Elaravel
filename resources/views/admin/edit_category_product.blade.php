                ...
                <div class="position-center">
                    <form role="form" action="{{ URL::to('/update-category-product/'.$edit_value->category_id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="category_product_desc" style="resize: none;" rows="5" id="exampleInputPassword1">
                                {{ $edit_value->category_desc }}
                            </textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Từ khóa danh mục</label>
                            <textarea class="form-control" name="category_product_keywords" style="resize: none;" rows="5" id="exampleInputPassword1">
