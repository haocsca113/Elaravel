...
<body>
    <div class="coupon">
        ...
        <div class="container" style="background-color: #fff;">
            <h2 class="note"><b><i>Giảm 20% cho tổng đơn hàng trên 2 triệu</i></b></h2>
        ...
        <div class="container">
            <p class="code">Sử dụng code sau: <span class="promo">POG113</span></p>
            <p class="expire">Ngày hết hạn code: 30-06-2025</p>
        </div>
    </div>
</body>
</html>